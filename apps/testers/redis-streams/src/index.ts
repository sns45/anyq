/**
 * @fileoverview Main entry point for Redis Streams tester
 */
...
app.get('/', (c) => {
  return c.json({
    ...
    version: '0.1.0',
    description: 'Redis Streams adapter tester for anyq',
    redis: {
    ...
    endpoints: {
      ...
      'POST /stats/pause': 'Pause consumer',
      'POST /stats/resume': 'Resume consumer',
    },
...
async function main() {
  console.log('🚀 Starting Redis Streams tester...');
